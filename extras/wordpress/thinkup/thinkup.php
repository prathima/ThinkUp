    ...
    public static function getOptionsArray($force_update = null) {
        if (!is_array(self::$options) || $force_update == 'force-update') {
            ...
            array(
                    ...
                    'description' => '(Optional) If the ThinkUp tables are located on a different server than the'.
                        ' WordPress tables.',
                    'type' => 'text',
            ...
            array(
                    ...
                    'description' => '(Optional) If the ThinkUp tables are located in a different database than the'.
                        ' WordPress tables.',
                    'type' => 'text',
